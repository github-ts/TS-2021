...
<table cellpadding="15" cellspacing="0" class="ps1-style3" style="width: 100%; height: 100%;">
	<tr>
		<td class="auto-style7" colspan="2"><span class="ps1-style8">PRESCENE.2021.V1.0REV6-TS</span></td>
	</tr>
	<tr>
		<td colspan="2"><br class="ps1-style1" />
	...
	<tr>
		<td class="no-style" colspan="2">No. <?php
/* Connection Data */
...
?></font>
	...
	<tr>
		...
		<font class="ps1-style8">
		<a href="?to=index:section:anonym!ze" target="_self">ANONYM!ZE</a><span class="ps1-style5"> | 
		...
		</span><a href="?to=index:section:xdcc" target="_self">XDCC</a>
		<span class="ps1-style5">|</span>
<font>
		<a href="?to=index:section:addsite" target="_self" title="Click here to add site!">
		<font color="#00ff00">+</font></a></td>
		<td class="auto-style3" style="height: 50px; color: #00ff00">
		&nbsp;</td>
	</tr>
	<tr><td class="ps1-style1" style="height: 56px" colspan="2">
<!-- CONTENT LOADER -->
<?php
# get
$to = $_GET['to'];
